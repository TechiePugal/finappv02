...
const NAV = [
  ...
  { group:'Formed Chits (You Manage)', color:'#007AFF', items:[
    ...
    { to:'/cf/formed-expected-fund', label:'Expected Fund', icon:<><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></> },
  ...
  { group:'Joined Chits (You Joined)', color:'#34C759', items:[
    ...
    { to:'/cf/other-chit-companies', label:'Companies / Agents', icon:<><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h1M9 13h1M14 9h1M14 13h1"/></> },
    { to:'/cf/joined-auctions', label:'Auctions', icon:<><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 3"/></> },
    { to:'/cf/expected-fund', label:'Expected Fund', icon:<><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></> },
